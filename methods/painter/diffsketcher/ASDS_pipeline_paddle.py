...
class Token2AttnMixinASDSPipeline_paddle(StableDiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        text_embeddings, negative_text_embeddings = self.encode_prompt(
    ...
    def score_distillation_sampling(self,
        ...
        alphas = self.scheduler.alphas_cumprod.to(device)  # for convenience
